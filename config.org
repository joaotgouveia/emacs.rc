...
(add-to-list 'nerd-icons-extension-icon-alist '("ll" nerd-icons-faicon "nf-fa-dragon" :face nerd-icons-blue))
(add-to-list 'nerd-icons-extension-icon-alist '("sol" nerd-icons-mdicon "nf-md-ethereum" :face nerd-icons-blue))
#+end_src
...
** lsp-java
Handle server installation and session management.
...
(use-package lsp-java
  ...
  (setq lsp-java-format-settings-url "~/.config/java-formatter/eclipse-java-google-style.xml"))
#+end_src
...
#+begin_src emacs-lisp
(load "./modes/llvm-coding-guidelines.el")
#+end_src
...
** format-latex
Configuration options for ~latex-preview~
...
(use-package citar
  :custom
  (org-cite-global-bibliography '("~/wiki/slipbox/library.bib"))
...
(use-package elfeed
  ...
  (setq elfeed-feeds
    '(("https://www.phoronix.com/rss.php" phoronix tech)
      ...
      ("https://www.aeaweb.org/research/rss-feed" aea economics)
      ("https://www.federalreserve.gov/feeds/ifdp.xml" ifdb economics)
      ("https://www.federalreserve.gov/feeds/feds.xml" feds economics)
      ("https://www.federalreserve.gov/feeds/feds_notes.xml" feds-notes economics))))
